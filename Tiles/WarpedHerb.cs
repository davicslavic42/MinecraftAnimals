using MinecraftAnimals.Items.Herbs;
...
namespace MinecraftAnimals.Tiles
{
	...
	public class WarpedHerb : ModTile
	{
		...
		public override bool Drop(int i, int j)
		{
			...
			if (stage == PlantStage.Grown)
				Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ItemType<WarpedFungus>());
