...
{
	public class SpiderWall : ModNPC
	{
		...
		public override void FindFrame(int frameHeight)
		{
			...
			npc.spriteDirection = (int)npc.rotation;
			npc.direction = (int)npc.rotation * (int)npc.velocity.X;
			npc.rotation = (float)Math.Atan2((double)npc.velocity.Y, (double)npc.velocity.X);
			{
				npc.frameCounter++;
				...
				{
					npc.frame.Y = Frame_Crawl_2 * frameHeight;
				}
				else if (npc.frameCounter < 30)
				{
					npc.frame.Y = Frame_Crawl_3 * frameHeight;
				}
				else if (npc.frameCounter < 40)
				{
					npc.frame.Y = Frame_Crawl_4 * frameHeight;
				}
				else
				{
					npc.frameCounter = 0;
