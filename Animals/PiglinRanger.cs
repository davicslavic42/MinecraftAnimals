...
{
    public class PiglinRanger : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            else if (AI_State == State_Shoot)
            {
                ...
                if (npc.frameCounter == 145)
                {
                    ...
                    Projectile.NewProjectile(npc.Center, PlayerDir.RotatedByRandom(0.1f) * 8f, mod.ProjectileType("Arrow"), 18, 3, Main.LocalPlayer.whoAmI);
                }
                else
                {
