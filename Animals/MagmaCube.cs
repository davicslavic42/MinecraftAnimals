        ...
        public override void AI()
        {
            ...
            if (Phase == (int)AIStates.Death)
            {
                ...
                if (npc.ai[2] >= 110f)
                {
                    ...
                    for (int y = 0; y < 1; y++)
                    {
                        NPC.NewNPC(Main.rand.Next((int)npc.position.X - 95, (int)npc.position.X + 95), Main.rand.Next((int)npc.position.Y - 55, (int)npc.position.Y), NPCType<MagmaPiece>(), 0);
                    }
                    npc.life = 0;
                }
            }
